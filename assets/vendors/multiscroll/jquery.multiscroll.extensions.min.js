...
//			'fixedElements': null,
		...
		if (options.navigation) {
			...
			for (var i = 0; i < $('.ms-left .ms-section').length; i++) {
				...
				var li = '<li>'
							+ '<a class="link-nav animated-middle opacity-0" href="/assets/#' + link + '">' + '<span>' + (tooltip != '' ? '<div class="multiscroll-tooltip ' + options.navigationPosition + '">' + tooltip + '</div>' : '') + '</span></a>'
		...
		$('.ms-left .ms-section, .ms-right .ms-section').each(function(){
			...
			if($(this).closest('.ms-left').length && options.navigation) {
				...
				// if (options.navigation) {
				// 	nav.find('ul').append('<li data-tooltip="' + tooltip + '"><a href="/assets/#' + link + '"><span></span></a></li>');
				// }
			}
		});
		...
		*/
		...
		function activateNavDots(name, sectionIndex){
			if(options.navigation){
				...
				if(name){
					$('#multiscroll-nav').find('a[href="/assets/#' + name + '"]').addClass('active');
				}else{
